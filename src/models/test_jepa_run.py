...
class VJEPALatentExtractor(nn.Module):
    ...
    def forward(self, frames, action=torch.tensor([2])):
        ...
        pred_latent = pred_latent = pred_seq.mean(dim=1)  # ✅ ALWAYS [B, D]
        return pred_latent
...
class DQN(nn.Module):
    ...
    def forward(self, x, latent):
        ...
        if latent.dim() == 3:
            latent = latent.mean(dim=1)  # emergency fix
...
def evaluate_jepa_dqn(
    ...
    # Load DQN checkpoint
    # -------------------------
    checkpoint = torch.load(dqn_checkpoint, map_location=DEVICE)
...
##/home/cody/Documents/IHL/eye-world/tb_logs/DQN_4/checkpoint_ep3500.pth
# /home/cody/Documents/IHL/eye-world/tb_logs/DQN_11/checkpoint_ep150.pth
# /home/cody/Documents/IHL/eye-world/tb_logs/DQN_13/checkpoint_ep3500.pth
# /home/cody/Documents/IHL/eye-world/tb_logs/DQN_13/checkpoint_ep2000.pth
if __name__ == "__main__":
    evaluate_jepa_dqn(
        dqn_checkpoint="/home/cody/Documents/IHL/eye-world/tb_logs/DQN_15/checkpoint_ep2000.pth",
        jepa_checkpoint="/home/cody/Documents/IHL/eye-world/tb_logs/ms_pacman/vjepa_world_model/version_9/checkpoints/epoch=49-step=164350.ckpt",
        num_episodes=100,
    )
...
def train():
    ...
    while True:
        ...
        if episode % 50 == 0:
            ...
            torch.save(
                checkpoint,
                os.path.join(log_dir, f"checkpoint_ep{episode}.pth"),
            )

            # optional: always keep latest
